...
\begin{itemize}
	\item
	Currently I am doing my masters thesis under professor Phalguni Gupta, The title of my thesis is "Biometric Online signature verification using digital Pad "  , which is MHRD sponsered project.
\end{itemize}
...
\item[]
\begin{itemize}
	\item Elected as techncal assistance(TA) in cs220(Computer Organisation) course.helped the course students in implemntationof ALU , Regfile, Ram , CPU in Spartan series 3 FPGA Board.
\end{itemize}
\item[]
\begin{itemize}
