...
\textbf{\Large Ashutosh Pathak} \\ Btech -Mtech,Dual degree, Computer Science Engineering & 07552689515 ,9873600772\\
Indian Institute of Technology Kanpur & atp.iitk@gmail.com\\
\end{tabular*}
\\
\vspace{-0.1in}
...
\begin{itemize}
\item
 All India Rank \textbf{416 in IIT-JEE} exam in 2004 in general category.
\end{itemize}

\item[]
\begin{itemize}
 \item  All India Rank 1200 in the AIEEE 2004 with state rank 12.
 \end{itemize}
...
\rmfamily
\vspace{-0.2in}
\resheading{Work Experiance}
\vspace{-0.2in}
\begin{description}

\item[]
\begin{itemize}
\item{ \textbf{ Current \textbf{Literaturebay.com }  (Nov 2010- ongoing)}\\
\item{Currently  developing an E-commerce website using Cakephp framework for the online selling of secondhand books. The work involved the full database designing, userlevel access control list. Cakephp is a fully supported MVC framework using php. Ongoing work includes debuging of site ,android app and payment gateway integration.}
 
 
\item{ Designed  website fully supported latest facebook app frame work such as OAuth2.0, CSRF protection.}
 
\item{ Designed website has advanced search feature using natural language and LRU  caching facility which was developed mannualy. Future work involving automatic string correction using lipschitz  or edit distance algorithm }
 
\item{ Designed website support dynamic multi level categories modification and retrieval O(1) algorithm using custom modified preorder traversal. }

\item{ Designed website support custom spam protection framework for user information. }
 
\item{ Designed website support 3 level taging support with weight handeling which fulfill Folksonomy and web 2.0 standards.  }
...
\item[]
\begin{itemize}
\item{ \textbf{Knowlarity communications (startup)    (July 2010- Octuber 2010)}\\
Knowlarity communication is a telecom startup founded by IIT-kanpur 2000 batch passout.
There main product is a cloud based telephony network for telemarketing and call centre companies. 
...
\hline
 Mtech &Indian Institute of Technology, Kanpur(2008-2009) & 7.2/10.0\\
 \hline
 Btech &Indian Institute of Technology, Kanpur(2004-2008) & 6.1/10.0\\
\hline
